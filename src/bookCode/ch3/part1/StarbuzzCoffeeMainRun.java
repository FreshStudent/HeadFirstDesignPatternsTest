...
public class StarbuzzCoffeeMainRun {
	...
	public static void main(String args[]) {
		...
		AbstractBeverage beverage = new Espresso();  //一杯Espresso，不需要任何调料，打印出它的描述和价钱
		...
		AbstractBeverage beverage3 = new HouseBlend();  //制造一个HouseBlend对象
		...
		AbstractBeverage beverage4 = new Decaf();  //制造一个Decaf对象
		...
		AbstractBeverage beverage5 = new Decaf();  //制造一个Decaf对象
